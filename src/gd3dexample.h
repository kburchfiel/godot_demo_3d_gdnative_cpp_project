...
namespace godot {
    ...
    class GD3DExample : public KinematicBody {
        GODOT_CLASS(GD3DExample, KinematicBody)
        ...
        // godot::KinematicBody* _kinematic_body; since the class itself
        // is a KinematicBody, I don't think I need to include this item a second time here. (After all, there isn't 
        // a second KinematicBody below the original KinematicBody item.)
